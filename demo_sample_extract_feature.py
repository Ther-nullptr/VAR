...
def forward_hook(module, input, output):
    # a hook for visualize the input feature map of linear input(input only)
...
if __name__ == '__main__':
    ...
    vae_ckpt, var_ckpt = f'{var_ckpt_dir}/vae_ch160v4096z32.pth', f'{var_ckpt_dir}/var_d{MODEL_DEPTH}_new.pth'
    ...
    vae.eval().to(torch.float16), var.eval().to(torch.float16)
    ...
    chw.save(f'./var_d{MODEL_DEPTH}_cfg{cfg}_seed{seed}.png')
